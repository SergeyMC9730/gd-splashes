...
unsigned int Hash::rndnums[256] = { 0x568c, 0x54388, 0xd5c9, 0xbfc1,
...
signed int Hash::get(const char* string){
    unsigned int string_size = strnlen(string, 4096);
...
const char* Hash::get(const char* string, bool v) {
    char buffer[1024];
    return itoa(get(string), buffer, 10);
}
